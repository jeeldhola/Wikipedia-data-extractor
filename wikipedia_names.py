...
# topics = ['The Great Pyramid of Giza','Marie Curie','The Beatles','World War I','Mount Everest','The Roman Empire','The Solar System','The Renaissance','Barack Obama','The Titanic','The Cold War','Ancient Egypt','The Mona Lisa','Winston Churchill','The Human Genome Project','The Great Wall of China','Jane Austen','The Industrial Revolution','The Eiffel Tower','Pablo Picasso','The American Civil War','The Taj Mahal','Albert Einstein','The French Revolution','The Wright Brothers','Leonardo da Vinci','Nelson Mandela','The Panama Canal','The Apollo 11 Mission','The Mayan Civilization','The Black Death','Queen Elizabeth II','The Renaissance','The Amazon Rainforest','The Olympic Games','The Seven Wonders of the Ancient World','The Space Race','The Crusades','The United Nations','The Sistine Chapel','Mahatma Gandhi','The Titanic','William Shakespeare','The Silk Road','The Berlin Wall','The Himalayas','The Mona Lisa','The Great Barrier Reef','The First World War','The Second World War']
...
for topic in topics:
    try:
        summary = wikipedia.summary(topic, sentences=1000) # this will get the first 2 sentences of the summary
        print(summary)
        data.append([topic, summary])
...
df = pd.DataFrame(data, columns=['Topic', 'Summary'])
df.to_excel('wikipedia_data_app.xlsx', index=False)
